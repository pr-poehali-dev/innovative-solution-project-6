...
export const CATEGORY_BANNERS: Record<string, CategoryBanner> = {
  ...
  "asfalt-beton": {
    ...
    title: "Асфальт и бетон",
    subtitle: "Ровное покрытие двора, площадки и подъезда",
    text: "Товарный бетон М200–М400 с доставкой миксером и асфальтирование под ключ: снимаем грунт, отсыпаем щебнем, укладываем асфальт и укатываем катком. Работаем по дворам частных домов, площадкам предприятий и подъездным путям. Считаем объём по вашим замерам и привозим ровно столько, сколько нужно.",
    bullets: [
      { icon: "Layers", title: "Бетон М200–М400", text: "Заводской, с паспортом качества" },
      { icon: "Truck", title: "Доставка миксером", text: "От 1 м³, подача в опалубку" },
      { icon: "Construction", title: "Асфальт под ключ", text: "Основание, укладка, укатка катком" },
      { icon: "FileText", title: "Работаем с юр. лицами", text: "Договор, НДС, ЭДО, безнал" },
    ],
  },
  bytovki: {
