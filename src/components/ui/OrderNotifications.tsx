...
type NotificationKind = "truck" | "asphalt";
...
const notifications: NotificationItem[] = [
  ...
  {
    name: "ООО «Магнит-Логистик»",
    district: "Кстово",
    truck: "асфальтирование парковки 1 200 м²",
    time: "21 минута назад",
    kind: "asphalt",
    verb: "заказали",
  },
  ...
  { name: "Михаил", district: "Бор", truck: "КАМАЗ со стрелой 23 м", time: "31 минута назад" },
  {
    name: "ТСЖ «Заречный»",
    district: "Канавино",
    truck: "асфальтирование двора 450 м²",
  ...
  {
    name: "ООО «АвтоПарк-НН»",
    district: "Автозаводский район",
    truck: "ямочный ремонт 220 м²",
    time: "48 минут назад",
    kind: "asphalt",
    verb: "заказали",
  },
  { name: "Павел", district: "Московский район", truck: "КАМАЗ 15 тонн", time: "52 минуты назад" },
  {
    name: "ООО «ГрандСтрой»",
    district: "Дзержинск",
    truck: "укладка асфальта 2 100 м²",
    time: "58 минут назад",
    kind: "asphalt",
    verb: "заказали",
  },
    ...
    >
      <div className="flex items-start gap-3 p-3 sm:p-4 rounded-2xl border border-accent/30 bg-black/85 backdrop-blur-md shadow-[0_15px_40px_rgba(0,0,0,0.5)]">
        <div className="relative flex-shrink-0 w-10 h-10 sm:w-11 sm:h-11 rounded-full bg-accent/15 flex items-center justify-center">
          <Icon
            name={n.kind === "asphalt" ? "Construction" : "Truck"}
            size={20}
        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="text-[11px] sm:text-xs text-white/70 leading-snug mt-0.5">
            {n.verb ?? "заказал"} <span className="text-accent font-medium">{n.truck}</span>
          </div>
