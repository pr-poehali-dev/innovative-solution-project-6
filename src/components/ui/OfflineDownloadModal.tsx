...
const OfflineDownloadModal = () => {
  ...
  // Слушаем событие открытия (от кнопки)
  useEffect(() => {
    const handler = () => openAndStart();
  ...
  return (
    <div
      className="fixed inset-0 z-[200] flex items-end sm:items-center justify-center bg-black/70 backdrop-blur-sm p-4 animate-in fade-in duration-200"
      onClick={close}
    >
      <div
