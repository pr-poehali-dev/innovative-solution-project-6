const SeoMeta = () => {
  return (
    <>
      <title>Аренда манипулятора в Нижнем Новгороде — заказать услуги от 1500 ₽/час</title>
      <meta name="description" content="Аренда манипулятора в Нижнем Новгороде от 1500 ₽/час. Подача от 1 часа, без выходных. До 20 т, стрела 23 м. Оператор включён. ☎ +7 960 188-30-84" />
