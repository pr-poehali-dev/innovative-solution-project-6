const SeoMeta = () => {
  ...
  const description = "Аренда и услуги манипулятора в Нижнем Новгороде от 1500 ₽/час. Доставка строительных материалов: кирпич, блоки, плиты, цемент, бордюр, пиломатериалы, бетон. Свой парк 15 машин, оператор включён, подача за 60 минут, работаем 24/7. Договор для юр. лиц, ЭДО, безнал. ☎ 283-75-00 — Фаворит, опыт 10+ лет.";
