const SeoMeta = () => {
  const title = "Аренда манипулятора в Нижнем Новгороде — услуги манипулятора от 1500 ₽/час ☎ +7 (960) 188-30-84";
  const description = "Аренда манипулятора в Нижнем Новгороде от 1500 ₽/час с НДС. Услуги манипулятора с оператором — подача за 60 минут, работаем 24/7. Грузоподъёмность до 17 т, стрела до 23 м, люлька, бур. Свой парк 15 машин. Договор для юр.лиц, ЭДО, безнал. ☎ +7 (960) 188-30-84 — Фаворит, опыт 10+ лет.";
