const SeoMeta = () => {
  ...
  const keywords = [
    ...
    "перевозка манипулятором Нижний Новгород",
    "перевозка бытовок манипулятором",
    "перевозка контейнеров манипулятором",
    "перевозка спецтехники манипулятором",
    "манипулятор с люлькой Нижний Новгород",
    "манипулятор с буром Нижний Новгород",
