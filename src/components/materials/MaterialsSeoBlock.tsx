...
const groups = [
  ...
  },
  {
    ...
    text: "Аренда крана-манипулятора с оператором от 1900 ₽/час. Подача за 60 минут, работаем 24/7. Техника зарегистрирована в Ростехнадзоре, операторы с допусками.",
    queries: [
  ...
  {
    icon: "Grid3x3",
    title: "Купить бордюр дорожный и тротуарный",
    text: "Дорожный и тротуарный бордюрный камень с доставкой поддонами. Кран ставит камень прямо вдоль линии укладки — можем и установить своей бригадой.",
    queries: [
      "бордюрный камень купить Нижний Новгород",
      "тротуарный бордюр с доставкой",
      "дорожный бордюр цена за штуку",
      "бордюр с установкой под ключ",
      "поребрик купить с доставкой",
    ],
    cat: "/stroymaterialy/bordyur",
  },
];
