...
export const terms = [
  ...
  },
  {
    ...
    text: "Цены указаны с НДС 20% — сумма в счёте совпадает с той, что назвали по телефону. Для постоянных клиентов — оплата по факту с отсрочкой до 14 дней.",
  },
  {
    icon: "ShieldCheck",
  ...
  },
  {
    ...
    text: "Работаем по всей Нижегородской области: Дзержинск, Кстово, Бор, Арзамас, Богородск, Балахна. В радиусе 50 км наценки за километраж нет.",
  },
];
