...
const faqs = [
  {
    ...
    answer:
      "Стоимость аренды манипулятора — от 2200 ₽/час с оператором. Минимальный заказ — 4 часа. Цена зависит от грузоподъёмности и типа техники: ISUZU 5т — от 2200 ₽/час, КАМАЗ 65115 — 2800 ₽/час, FAW + КМУ DongYang — 3000 ₽/час, КАМАЗ 43118 вездеход — 3500 ₽/час. Для корпоративных клиентов — индивидуальные тарифы по договору.",
  },
  {
