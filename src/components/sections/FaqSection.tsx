...
export const faqs = [
  ...
  },
  {
    ...
    answer:
      "Стоимость услуг манипулятора в Нижнем Новгороде — от 1900 ₽/час с оператором. Минимальный заказ — 4 часа. Цена зависит от грузоподъёмности и типа техники: ISUZU 5т — от 2700 ₽/час, КАМАЗ 65115 — 3500 ₽/час, FAW + КМУ DongYang — 3700 ₽/час, КАМАЗ 43118 вездеход — 4300 ₽/час. Для корпоративных клиентов и постоянных заказчиков — индивидуальные тарифы по договору со скидкой.",
  },
  {
