    ...
    >
      <div className="max-w-6xl mx-auto">
        ...
        <div className="sr-only">
          ...
          <h3>Асфальтирование Дзержинск Кстово Арзамас Богородск Городец Бор</h3>
          <h3>Асфальтирование дворов многоквартирных домов</h3>
          <h3>Асфальтирование парковок торговых центров</h3>
          <h3>Асфальтирование промышленных площадок и складов</h3>
          <h3>Асфальтирование дорог IV и V категории</h3>
          <h3>Ямочный ремонт асфальтового покрытия горячим способом</h3>
          <h3>Стоимость асфальтирования за квадратный метр под ключ</h3>
          <h3>Асфальтирование с гарантией 3 года по ГОСТ 9128-2013</h3>
          <h3>Срочное асфальтирование за 1 день в Нижнем Новгороде</h3>
          <h3>Асфальтирование для УК, ТСЖ и застройщиков с НДС</h3>
          <p>
            Заказать асфальтирование в Нижнем Новгороде у компании ООО «Фаворит» можно
            по телефону +7 (960) 169-09-90. Выполняем все виды дорожно-строительных работ:
            укладка асфальта, асфальтирование дворов, парковок, дорог, ямочный ремонт,
            подготовка основания, установка бордюров. Используем асфальтобетонные смеси
            марки М1, М2, М3 по ГОСТ 9128-2013. Собственный парк техники: асфальтоукладчики
            Vögele, катки Bomag и Hamm, фрезы Wirtgen, самосвалы и экскаваторы. Гарантия
            до 3 лет, безналичный расчёт с НДС, договор и закрывающие документы, ЭДО для
            юридических лиц. Бесплатный выезд замерщика и расчёт сметы в течение 24 часов.
            Работаем по Нижнему Новгороду и области: Дзержинск, Кстово, Бор, Балахна,
            Богородск, Арзамас, Городец, Павлово, Выкса, Лысково, Кулебаки. Цена
            асфальтирования от 450 рублей за квадратный метр при объёмах от 5 000 м².
          </p>
          <p>
            Технология асфальтирования: геодезические работы и разметка, демонтаж старого
            покрытия фрезерованием, подготовка основания, отсыпка щебня фракции 20-40 и
            песка, проливка битумной эмульсией, укладка горячей асфальтобетонной смеси
            при температуре 140-160°C, послойное уплотнение катками. Толщина асфальтового
            покрытия от 4 до 12 см в зависимости от назначения и нагрузки. Срок выполнения
            работ от 1 дня для типовой площадки до 500 м².
          </p>
          <p>
            Цена асфальтирования двора в Нижнем Новгороде от 650 руб/м², асфальтирование
            парковки от 550 руб/м², асфальтирование дороги от 480 руб/м², асфальтирование
            промплощадки от 450 руб/м², ямочный ремонт от 850 руб/м². Стоимость зависит
            от площади, толщины покрытия, удалённости объекта и состояния основания.
          </p>
        </div>
      </div>
    </section>
