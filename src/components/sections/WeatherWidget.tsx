...
const WeatherWidget = () => {
  ...
  return (
    <section className="py-4 sm:py-10 bg-black/30">
      <div className="max-w-7xl mx-auto px-3 sm:px-6">
        <div className="relative rounded-2xl border border-accent/20 bg-gradient-to-br from-sky-950/40 via-black/60 to-accent/5 md:backdrop-blur-sm overflow-hidden repaint-safe shadow-[0_10px_40px_rgba(0,0,0,0.4)]">
          ...
          <div className="sm:hidden">
            ...
            {range === 3 ? (
              <div className="grid grid-cols-3 divide-x divide-white/10 repaint-safe">
              ...
              <div className="grid grid-cols-7 divide-x divide-white/10 repaint-safe">
