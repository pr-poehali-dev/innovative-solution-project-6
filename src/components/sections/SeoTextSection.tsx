        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
          <article className="p-5 sm:p-7 rounded-2xl border border-accent/20 bg-card/40 backdrop-blur-sm">
            ...
            <p className="text-muted-foreground text-sm sm:text-base leading-relaxed">
              Стоимость услуг манипулятора — от 1800 ₽/час с оператором. Работаем по всему Нижнему Новгороду и области без выходных.
            </p>
          </article>
          ...
          <article className="p-5 sm:p-7 rounded-2xl border border-accent/20 bg-card/40 backdrop-blur-sm">
            ...
            <p className="text-muted-foreground text-sm sm:text-base leading-relaxed mb-3">
              Стоимость аренды манипулятора зависит от грузоподъёмности и типа техники: от 1800 ₽/час, ISUZU 5т — от 2200 ₽/час, КАМАЗ 65115 — 2800 ₽/час, FAW с КМУ DongYang — 3000 ₽/час, КАМАЗ 43118 вездеход — 3500 ₽/час.
            </p>
            <p className="text-muted-foreground text-sm sm:text-base leading-relaxed">
