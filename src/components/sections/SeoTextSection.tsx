...
const cards = [
  {
    ...
    paragraphs: [
      ...
      "Стоимость услуг манипулятора — от 1900 ₽/час с оператором. Работаем по всему Нижнему Новгороду и области без выходных.",
    ],
  ...
  },
  {
    ...
    paragraphs: [
      "Стоимость аренды манипулятора зависит от грузоподъёмности и типа техники: от 1900 ₽/час, ISUZU 5т — от 2700 ₽/час, КАМАЗ 65115 — 3500 ₽/час, FAW с КМУ DongYang — 3700 ₽/час, КАМАЗ 43118 вездеход — 4300 ₽/час.",
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-8 sm:mb-12">
          ...
          <p className="text-muted-foreground text-sm sm:text-base max-w-3xl mx-auto">
            <strong className="text-white/90">Аренда манипулятора в Нижнем Новгороде</strong> от ООО «Фаворит» — собственный автопарк крано-манипуляторных установок (КМУ) с 2015 года. Оказываем <strong className="text-white/90">услуги манипулятора в Нижнем Новгороде</strong> и области для строительных, промышленных и логистических задач: аренда манипулятора с оператором от 1900 ₽/час, подача за 60 минут.
          </p>
        </div>
