        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col sm:grid sm:grid-cols-3 gap-4 mb-5">
            ...
            <div className="flex flex-col sm:flex-col gap-2 sm:col-span-2 sm:justify-end">
              ...
              <a
                href="https://wa.me/79601690990"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center gap-2 px-4 py-2.5 border border-green-500/50 rounded-xl text-green-400 font-medium hover:bg-green-500/10 transition-all text-sm w-full"
              >
                💬 Написать директору
              </a>
              <a
