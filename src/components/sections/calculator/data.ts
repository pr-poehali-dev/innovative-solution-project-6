...
export const trucks: Truck[] = [
  ...
  { name: "FAW J6 + КМУ DONGYANG 1966", short: "FAW J6 + Бур", price: 3500, category: "Манипулятор", capacity: "до 17 т", boom: "22 м", highlight: "Эксклюзив · Бур", image: "https://cdn.poehali.dev/projects/9addb698-8864-4aa0-966e-52239521a692/bucket/wm/cb1469ab-3878-4eea-9eac-9ce6f4129301.webp" },
  ...
  { name: "Автокран Галичанин КС-55713 (КАМАЗ)", short: "Автокран 25 т", price: 2500, category: "Автокран", capacity: "до 25 т", boom: "24 м", highlight: "Грузоподъёмность 25 т", image: "/fleet/avtokran-galichanin-25t.webp" },
];
