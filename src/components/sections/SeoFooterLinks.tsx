...
const linkGroups: LinkGroup[] = [
  {
    ...
    links: [
      ...
      { label: "Манипулятор 10 тонн", to: "/arenda-manipulyatora-10-tonn" },
  ...
  },
  {
    ...
    links: [
      ...
      { label: "Перевозка спецтехники", to: "/perevozka-spetstehniki-manipulyatorom" },
      { label: "Манипулятор 10 тонн", to: "/arenda-manipulyatora-10-tonn" },
      { label: "Манипулятор в Дзержинске", to: "/arenda-manipulyatora-dzerzhinsk" },
  ...
  },
  {
    ...
    links: [
      { label: "Перевозка спецтехники", to: "/perevozka-spetstehniki-manipulyatorom" },
      { label: "Перевозка бытовок и вагончиков" },
      { label: "Перевозка контейнеров" },
      { label: "Перевозка плит перекрытия" },
      { label: "Перевозка кирпича и блоков поддонами" },
      { label: "Перевозка пиломатериалов" },
      { label: "Перевозка станков и оборудования" },
      { label: "Перевозка гаражей и павильонов" },
    ],
  },
];
    ...
    <section className="py-10 sm:py-16 px-4 sm:px-6 border-t border-accent/10 bg-accent/[0.03]">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mt-6 sm:mt-8 text-center text-[11px] sm:text-xs text-muted-foreground/60 max-w-3xl mx-auto leading-relaxed">
          ...
          Стоимость услуг манипулятора — от 1900 ₽/час с оператором.
        </div>
      </div>
    </section>
  );
