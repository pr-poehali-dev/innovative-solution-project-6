...
const trucks: Record<string, {
  ...
  "faw-kmu-dongyoung": {
    ...
    description: "Мощный манипулятор на базе FAW с крано-манипуляторной установкой DongYang. Грузоподъёмность кузова до 17 тонн и вылет стрелы до 21 метра делают эту машину незаменимой для монтажных работ на высоте. Оснащён монтажной люлькой для работы на высоте.",
    specs: [
  ...
  "kamaz-65115-hangil": {
    ...
    description: "Надёжный манипулятор на базе КАМАЗ 65115 с крано-манипуляторной установкой HANGIL. Платформа до 12 тонн и вылет стрелы до 19 метров — оптимальное решение для строительства и промышленных объектов в Нижнем Новгороде.",
    specs: [
  ...
  "kamaz-43118-kanglim": {
    ...
    description: "Полноприводный манипулятор-вездеход на базе КАМАЗ 43118 с КМУ Kanglim. Максимальный вылет стрелы 23 метра — самый большой в парке. Незаменим для работы на бездорожье, в труднодоступных местах и при монтаже на значительной высоте.",
    specs: [
  ...
  "isuzu-5t-kmu": {
    ...
    description: "Компактный и манёвренный манипулятор на базе ISUZU грузоподъёмностью 5 тонн. Идеально подходит для работы в стеснённых условиях — во дворах, на узких улицах и небольших объектах. Самый доступный вариант в нашем парке.",
    specs: [
