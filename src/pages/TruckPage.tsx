...
const trucks: Record<string, {
  ...
  "jcb-4cx": {
    ...
    description: "Компания «Фаворит» предлагает в аренду экскаватор-погрузчик JCB 4CX в Нижнем Новгороде и области. Универсальная машина совмещает функции экскаватора и погрузчика: глубина копания до 5,58 м, погрузочный ковш 1,1 м³. Оснащён навесным оборудованием — идеальный выбор для земляных, погрузочных и коммунальных работ.",
    specs: [
