...
export const trucks: Record<string, Truck> = {
  ...
  "hyundai-gold-kmu-8t": {
    title: "Hyundai Gold + КМУ HIAB 8т",
    badge: "КМУ 8т · Стрела 22м",
    price: "3 200 ₽/час с НДС",
    priceNum: 3200,
    count: 1,
    tag: { label: "Длинная стрела", icon: "ArrowUpRight", color: "from-sky-500 to-blue-600" },
    ...
    alt: "Аренда Hyundai Gold с КМУ HIAB 8 тонн в Нижнем Новгороде",
    description: "Компания «Фаворит» предлагает в аренду манипулятор Hyundai Gold с тросовым КМУ HIAB грузоподъёмностью 8 тонн в Нижнем Новгороде и области. Длинная стрела 22 метра — одна из самых больших в нашем парке — позволяет работать на высотных объектах, монтировать конструкции на верхних этажах и подавать груз через ограждения и препятствия. Платформа 6,0 × 2,45 м и грузоподъёмность кузова 10 тонн делают машину универсальной для перевозки строительных материалов, кабельных барабанов и длинномерных грузов.\n\nМанипулятор Hyundai Gold от компании «Фаворит» отлично подходит для электромонтажных работ, прокладки кабельных трасс, обслуживания строительных площадок и монтажа на высоте. Шасси Hyundai Gold с колёсной формулой 6×4 обеспечивает уверенное движение по любым дорогам и хорошую проходимость на стройплощадках.\n\nГде применяется Hyundai Gold (КМУ 8т / 22 м):\n• перевозка кабельных барабанов и материалов для электромонтажа;\n• монтаж конструкций на высоте до 22 метров;\n• работы на верхних этажах строящихся зданий;\n• подача груза через ограждения, заборы и препятствия;\n• разгрузка ЖБИ — плит, колец, свай;\n• перевозка металлоконструкций и трубопроката;\n• установка опор освещения, рекламных конструкций;\n• монтаж бытовок, вагончиков и блок-контейнеров;\n• обслуживание промышленных и логистических объектов;\n• разгрузка фур и контейнеров на стройплощадках.\n\nНадёжное корейское шасси Hyundai Gold отличается высоким качеством сборки, мощным дизельным двигателем и комфортной кабиной для оператора. Тросовый КМУ HIAB — это европейский бренд №1 в мире кранов-манипуляторов: точная работа, плавность движений и долговечность.\n\nВся техника является собственностью ООО «Фаворит», находится в отличном техническом состоянии и обслуживается опытными квалифицированными операторами.",
    specs: [
  ...
  "hino-500-kmu-7t": {
    ...
    description: "Компания «Фаворит» предлагает в аренду манипулятор Hino 500 с КМУ Kanglim KS1256G-II в Нижнем Новгороде и области. Аренда манипулятора малой грузоподъёмности часто необходима при выполнении работ в условиях ограниченного пространства — эта спецтехника относится к числу наиболее компактных и манёвренных моделей. Крано-манипуляторная установка Kanglim KS1256G-II установлена на шасси грузовика Hino 500, который отличается высокой управляемостью на небольших по площади площадках. Конструкция установки обеспечивает работу с вылетом стрелы до 19 метров.\n\nМанипулятор Hino 500 от компании «Фаворит» — универсальная спецтехника для работы с грузами в самых разных условиях. Использование данной модели позволяет отказаться от привлечения дополнительного оборудования для погрузки и разгрузки материалов на объекте.\n\nГде применяется Hino 500 (КМУ 7т / 19 м):\n• в строительстве — отделочные, фасадные и кровельные работы, подъём и перемещение стройматериалов;\n• при благоустройстве территории — установка осветительных опор, монтаж вывесок, гирлянд и декоративных элементов;\n• для монтажа металлоконструкций и сэндвич-панелей;\n• для перевозки бытовок, вагончиков и блок-контейнеров;\n• при установке, ремонте и демонтаже рекламных конструкций;\n• для транспортировки бетонных колец, заборов и других изделий ЖБИ;\n• для перевозки кабельных барабанов;\n• при доставке строительных материалов любого типа;\n• для перевозки дорожных знаков, понтонов и бонов;\n• для транспортировки пластиковых и металлических труб;\n• для перевозки мобильных биокабинок и монтажных люлек;\n• для перевозки стеклянных пирамид и других изделий из стекла;\n• для транспортировки трубопроката и металлоизделий.\n\nГрузовик Hino 500 отличается современным дизайном, удобной трёхместной кабиной со спальным местом и продуманной эргономикой. Собственная масса машины — 12 тонн, при этом она способна перевозить до 6 тонн грузов. Автомобиль оснащён шестицилиндровым дизельным двигателем мощностью 260 л.с.... [truncated]
    specs: [
