...
const SLUG_META: Record<string, { title: string; description: string; keywords: string }> = {
  "/asfaltirovanie": {
    ...
    description: "Асфальтирование в Нижнем Новгороде и области под ключ от 450 ₽/м². Своя техника, гарантия 3 года, договор с НДС. Замер бесплатно. ☎ +7 (960) 169-09-90",
  ...
  "/asfaltirovanie-nizhny-novgorod": {
    ...
    description: "Заказать асфальтирование в Нижнем Новгороде. Свой парк техники, гарантия до 3 лет, договор с НДС. Замер бесплатно. ☎ +7 (960) 169-09-90",
  ...
  "/asfaltirovanie-dvorov": {
    ...
    description: "Асфальтирование дворов жилых домов под ключ. Работаем с УК, ТСЖ, застройщиками. Парковочные карманы, разметка. ☎ +7 (960) 169-09-90",
  ...
  "/asfaltirovanie-parkovok": {
    ...
    description: "Асфальтирование парковок от 100 до 10 000 м². Бордюры, водоотведение, разметка. Гарантия 3 года. ☎ +7 (960) 169-09-90",
  ...
  "/asfaltirovanie-dorog": {
    ...
    description: "Асфальтирование автодорог IV–V категории, подъездных путей, дорог в посёлках. Толщина 4–12 см. ☎ +7 (960) 169-09-90",
  ...
  "/ukladka-asfalta": {
    ...
    description: "Укладка асфальта горячим способом по ГОСТ 9128-2013. Своя техника: асфальтоукладчики, катки, фрезы. ☎ +7 (960) 169-09-90",
  ...
  "/yamochnyy-remont": {
    ...
    description: "Ямочный ремонт асфальтового покрытия горячим способом с фрезерованием краёв. Сезон апрель–октябрь. От 50 м². ☎ +7 (960) 169-09-90",
  ...
  "/asfaltirovanie-pod-klyuch": {
    ...
    description: "Асфальтирование под ключ: замер, смета, материалы, укладка — от одной бригады. Гарантия 3 года, договор с НДС. ☎ +7 (960) 169-09-90",
  ...
  "/asfaltirovanie-cena": {
    ...
    description: "Прайс-лист на асфальтирование: укладка от 450 ₽/м², ямочный ремонт от 600 ₽/м², бордюры от 550 ₽/п.м. ☎ +7 (960) 169-09-90",
  ...
  "/asfaltirovanie-dzerzhinsk": {
    ...
    description: "Асфальтирование дворов, парковок и дорог в Дзержинске. Выезд бригады в день обращения. ☎ +7 (960) 169-09-90",
    keywords: "асфальтирование Дзержинск, асфальт Дзержинск",
  },
  "/asfaltirovanie-kstovo": {
    title: "Асфальтирование в Кстово — Фаворит",
    description: "Асфальтирование под ключ в Кстово и Кстовском районе. Своя техника, гарантия 3 года. ☎ +7 (960) 169-09-90",
    keywords: "асфальтирование Кстово, асфальт Кстово",
  },
  "/asfaltirovanie-arzamas": {
    title: "Асфальтирование в Арзамасе — Фаворит",
    description: "Асфальтирование в Арзамасе и Арзамасском районе. Дворы, парковки, дороги под ключ. ☎ +7 (960) 169-09-90",
    keywords: "асфальтирование Арзамас, асфальт Арзамас",
  },
  "/asfaltirovanie-bogorodsk": {
    title: "Асфальтирование в Богородске — Фаворит",
    description: "Асфальтирование в Богородске и Богородском районе. Гарантия 3 года, договор с НДС. ☎ +7 (960) 169-09-90",
