      ...
      <section className="relative">
        <div className="relative w-full">
          ...
          <div className="absolute top-3 right-3 sm:top-6 sm:right-6 lg:top-10 lg:right-10">
            <div className="bg-accent/95 backdrop-blur-md px-3 py-2 sm:px-5 sm:py-3 rounded-xl sm:rounded-2xl shadow-2xl border-2 border-accent">
              <div className="text-[9px] sm:text-xs text-black/70 font-black uppercase tracking-wider">
                Цена работ
              </div>
          ...
          <div className="absolute inset-x-0 bottom-0">
            ...
            <div className="relative max-w-6xl mx-auto px-3 sm:px-6 pb-3 sm:pb-8 lg:pb-12">
              ...
              <div className="flex flex-row gap-2 sm:gap-3">
                <a
                  href={PHONE_TEL}
                  className="group relative inline-flex items-center justify-center gap-1.5 sm:gap-3 px-3 sm:px-6 py-2.5 sm:py-4 rounded-xl sm:rounded-2xl font-black bg-gradient-to-r from-accent via-accent to-amber-500 text-black overflow-hidden hover:shadow-2xl hover:shadow-accent/50 transition-all text-xs sm:text-lg flex-shrink-0"
                >
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-6">
            {[
              ...
              <div
                key={i}
                className="rounded-xl bg-card/40 border border-accent/20 backdrop-blur-sm p-3 sm:p-4 text-center sm:text-left hover:border-accent/50 transition-all"
              >
                <div className="text-2xl sm:text-3xl lg:text-4xl font-display font-black text-accent">
                  {s.v}
                </div>
